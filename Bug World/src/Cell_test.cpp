...
int main(int argc, char** argv) {
    ...
    if(t.get_color()!=r.get_color()||t.get_direction()!=r.get_direction()||
       t.get_food()!=r.get_food()||t.get_position()!=r.get_position()||
       t.get_progid()!=r.get_progid()||t.get_state()!=r.get_state()||
       t.is_dead()!=r.is_dead())
